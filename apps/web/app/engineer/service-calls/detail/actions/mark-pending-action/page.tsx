...
function MarkPendingActionContent() {
  const { user } = useAuth();
    ...
    try {
      ...
      const response = await fetch(
        `/api/engineers/service-calls/${callId}/update-status`,
        {
          ...
          body: JSON.stringify({
            newStatus: 'pending_action_required',
            note: note.trim(),
          }),
        }
      );
    ...
    <div className="min-h-screen bg-[#F8F9FB]">
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-2xl mx-auto px-6 py-4 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900">Pending Action Required</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-red-50 border border-red-100 rounded-lg p-4">
              <p className="text-sm text-red-900">
                Mark this call as requiring pending action. You must provide a reason explaining why this call requires action before it can proceed. This helps the manager understand the current status.
              </p>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Explain why this call requires action (e.g., waiting for customer callback, parts need to be ordered, etc.)"
...
export default function MarkPendingActionPage() {
  return (
    <ProtectedRoute allowedRoles={['engineer']}>
      <Suspense fallback={<div className="flex items-center justify-center h-screen">Loading...</div>}>
        <MarkPendingActionContent />
      </Suspense>
    </ProtectedRoute>
  );
}
